...
from excercise_3.backtracking import parsear_archivo
from excercise_3.programacion_lineal import batalla_naval_pl
from excercise_3.tests_backtracking import resultado_test
...
class GameTest:
    ...
    def run_naval_battle(self):
        ...
        _tablero, _demanda_satisfecha, demanda_insatisfecha = batalla_naval_pl(barcos, demands_rows, demands_columns)
        demand_fullfilled = (
            sum(demands_rows) + sum(demands_columns) - demanda_insatisfecha
        )
        return demand_fullfilled

class TestProgramacionLineal(unittest.TestCase):
...
def suite():
    ...
    suite.addTest(TestProgramacionLineal('test_pl_3_3_2'))
    suite.addTest(TestProgramacionLineal('test_pl_5_5_6'))
    suite.addTest(TestProgramacionLineal('test_pl_8_7_10'))
    suite.addTest(TestProgramacionLineal('test_pl_10_3_3'))
    suite.addTest(TestProgramacionLineal('test_pl_10_10_10'))
    suite.addTest(TestProgramacionLineal('test_pl_15_10_15'))
    suite.addTest(TestProgramacionLineal('test_pl_12_12_21'))
    suite.addTest(TestProgramacionLineal('test_pl_20_20_20'))
    suite.addTest(TestProgramacionLineal('test_pl_20_25_30'))
    suite.addTest(TestProgramacionLineal('test_pl_30_25_25'))
...
# python3 excercise_3/tests_programacion_lineal.py